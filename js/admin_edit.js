...
/*			$(".my_general_social_options .imapper-checkbox-on,.my_general_social_options .imapper-checkbox-off ").click(self.my_activate_so);
			...
			//$.each(self.checked_values,function(i,v){
				self.my_init_color_picker(".my_color_picker_title");
			//});
...
/*			var w_123=self.myGetViewport();
			...
			$(".my_dialog_preview").dialog({
				...
				close:function(){
					...
					//$(".my_dialog_preview iframe").contents().find("#my-save-loader").show();
					$(".my_dialog_preview #my-save-loader").hide();
		...
		this.my_open_color_picker=function(e){
			e.stopPropagation();
			var new_name=$(this).attr('data-my-name');
			var my_current_color_picker=self.my_picker_name;
			if(self.my_picker_name==new_name){
				
				$(".my_color_picker_title[data-my-name='"+my_current_color_picker+"'] .my_select_picker").show();
				$(".my_color_picker_title[data-my-name='"+my_current_color_picker+"'] .my_close_picker").hide();
				$(".my_color_picker_title[data-my-name='"+my_current_color_picker+"']").iris("hide");
				self.my_picker_name="";
			}else {
				...
				my_current_color_picker=$(this).attr('data-my-name');
				$(".my_color_picker_title[data-my-name='"+my_current_color_picker+"'] .my_select_picker").hide();
				$(".my_color_picker_title[data-my-name='"+my_current_color_picker+"'] .my_close_picker").show();
		...
		this.my_init_color_picker=function(sel){
			$(sel).each(function(){
				...
				var name=$(this).attr('data-my-name');
				//alert(name);
